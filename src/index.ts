...
// Membuat koneksi ke database MongoDB (Disini saya menggunakan MongoDB Atlas)
const dbUrl = 'mongodb+srv://prak7:prak7@prak7.ejhfmhu.mongodb.net/'; // Ganti dengan URL MongoDB Anda
